      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 space-x-1">
        <div className="col-span-6 flex flex-col justify-center">
          <h2 className="text-midnightblue text-4xl sm:text-5xl font-semibold text-center lg:text-start lh-143">
            Make a better world with Vanrakshak.
          </h2>
          <h3 className="text-black text-lg font-normal text-center lg:text-start lh-173 opacity-75 pt-3">
            VanRakshak serves as a powerful tool in the conservation and
            protection of forests by employing cutting-edge technologies to
            monitor, detect, and prevent threats to these vital ecosystems.
          </h3>
          <Link
            href={"/"}
